    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 70vh; gap: 32px;">
      ...
      <div style="display: flex; align-items: center; gap: 16px; margin-top: 16px;">
        ...
        <p class="font-body text-text-dim" style="font-size: 14px; line-height: 1.5; max-width: 400px; font-style: italic;">
          Type a card name or press <kbd style="font-family: 'JetBrains Mono', monospace; font-size: 11px; color: var(--color-primary-text, #5B9BF5); background: var(--color-surface, #14161C); padding: 2px 6px; border: 1px solid var(--color-border-ghost, #2A2D3A);">/</kbd> to start searching.
        </p>
      </div>
    </div>
  `;
