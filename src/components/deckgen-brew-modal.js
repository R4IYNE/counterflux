  ...
  return `
    <div
      x-data="{
        ...
        async kickoff() {
          ...
          // The BREWING surface (elapsed timer + live card count) is owned by
          // the review screen now — it takes over the instant status flips to
          // 'brewing', so the modal just kicks off and gets out of the way.
    ...
    >
      ...
      >
        ...
        <!-- Form body (the modal only shows while status is 'idle'; once the
             brew kicks off the review screen takes over with the BREWING UI). -->
