...
- [x] **Phase 14: v1.1 Audit Gap Closure** — Closed audit Issues A/C/D + 2 latent bugs from UAT (Phase 11 schema drift, Phase 13 auth-wall stale-static race) + 4 quality items pulled forward (Preordain dropdown sort, sync-errors bulk actions, reconcile one-shot guard, release calendar newest-first) + per-user reconcile keying + multi-deck precon ADD ALL (full bundle land per user intent — "if I own a precon, mark it owned and ALL cards land"); 10 plans landed; live UAT confirmed sync push lands cleanly; v1.1 ready to ship (completed 2026-04-27)
...
- [x] 08.1-02-PLAN.md — Precon coverage A+B: PRECON_EXTRA_CODES allowlist + multi-deck bundle size guard (FOLLOWUP-4A, FOLLOWUP-4B)
...
Plans:
- [ ] 14-01-PLAN.md — Issue A closure: sync push user_id stamp + live huxley UAT (SYNC-03, AUTH-06)
- [x] 14-02-PLAN.md — Issue C closure: retrospective 07-VERIFICATION.md + SCHEMA-01..03 checkbox flips (SCHEMA-01, SCHEMA-02, SCHEMA-03)
- [x] 14-03-PLAN.md — Issue D closure: spoiler-gallery bulkdata gate + regression test (MARKET-01, PERF-04)
- [ ] 14-04-PLAN.md — Close gate: re-run /gsd:audit-milestone + close-out addendum + STATE.md update
...
| 14. v1.1 Audit Gap Closure | v1.1 | 10/10 | Complete | 2026-04-27 |
