...
- [x] **Phase 14: v1.1 Audit Gap Closure** — Closed audit Issues A/C/D + 2 latent bugs surfaced during UAT (Phase 11 schema drift, Phase 13 auth-wall stale-static race) + 2 v1.2 quality items pulled forward (Preordain newest-first sort, sync-errors bulk RETRY/DISCARD) + 2 post-UAT polish items (reconcile one-shot guard, release calendar newest-first); 8 plans landed; live UAT confirmed sync push lands cleanly; v1.1 ready to ship (completed 2026-04-26)
...
| 14. v1.1 Audit Gap Closure | v1.1 | 8/8 | Complete | 2026-04-26 |
